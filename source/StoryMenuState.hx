...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x + grpWeekText.members[0].width + 10, txtWeekTitle.y + 10);
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, txtWeekTitle.y + 10).loadGraphic(Paths.image('Menu_Tracks'));
